...
EntityPlayer = ig.Box2DEntity.extend({
	...
	update: function() {
		...
		// var x = Math.cos(this.turnAngle);
		// var y = Math.sin(this.turnAngle);
		...
		// 	if(this.lastDirection > -90 && this.lastDirection < 90 || this.lastDirection > 270 && this.lastDirection > -90) {
		// 		//Facing up

		// 		x = x * 100;

		// 		//Decide if left or right
		// 		if(this.lastDirection > -180 && this.lastDirection < 0 || this.lastDirection > 359 && this.lastDirection > 180) {
		// 			this.body.ApplyForce( new b2.Vec2(-200,-100), this.body.GetPosition() );	
		// 			// console.log('left, up');
		// 		} else {
		// 			this.body.ApplyForce( new b2.Vec2(200,-100), this.body.GetPosition() );	
